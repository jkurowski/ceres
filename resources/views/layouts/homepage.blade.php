...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/styles.min.css') }}?v=21072026b" media="print" onload="this.media='all'">

    <!-- fallback dla no-js -->
    <noscript>
        <link rel="stylesheet" href="{{ asset('css/styles.min.css') }}?v=21072026b">
    </noscript>
