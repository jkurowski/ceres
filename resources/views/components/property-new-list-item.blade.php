        ...
        <div class="col-6 half-1">
            <div class="row">
                ...
                <div class="col-2 d-flex align-items-center property-list-item-col-5 gap-2">
                    ...
                    @else
                        @if ($p->status == 19)
                        <button class="bttn bttn-arrow bttn-xs bttn-gold d-inline-flex align-items-center justify-content-center" data-id="{{$p->id}}">
                    ...
                    @if($p->investment->type == 1)
                        <a class="bttn bttn-arrow bttn-xs bttn-gold d-inline-flex w-100 @if(Route::currentRouteName() === 'clipboard.index') pe-2 ps-2 ms-2 @endif" href="{{ route('developro.building.floor.property', [
                            $p->investment->slug,
                            $p->building,
                    ...
                    @elseif($p->investment->type == 2)
                        <a class="bttn bttn-arrow bttn-xs bttn-gold d-inline-flex w-100 @if(Route::currentRouteName() === 'clipboard.index') pe-2 ps-2 ms-2 @endif" href="{{ route('developro.property', [
                            $p->investment->slug,
                            $p->floor,
                            Str::slug($p->floor->name),
                            $p,
